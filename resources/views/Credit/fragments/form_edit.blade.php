...
<div class="form-group">
	...
	{!!Form::number('value',$credit_edit->value,['class'=>'form-control'])!!}
</div>
...
{!!Form::select('cart_id',$person2,$credit_edit->cart_id,['id'=>'person2','name'=>'cart_id','class'=>'form-control selectpicker'])  !!}
</div>
</div>
</div>
