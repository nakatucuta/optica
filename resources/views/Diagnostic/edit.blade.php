...
<!--   <button class="tablinks" onclick="openCity(event, 'observacion')">Observacion</button> -->
...
<button class="tablinks" onclick="openCity(event, 'formula')">Formula</button>
					...
					{!! Form::model($diagnosticMedical_record,['route'=>['diagnostic.update', $diagnosticMedical_record->id], 'method' => 'PUT']) !!} <!-- este es el que se comunica con el controlador en esa ruta con una variable -->
         
    @include('Diagnostic.fragments.formupdate')<!-- este es el que manda los formularios creados en el form que esta en fragment -->
