...
{!! Form::open(['route'=>'diagnostic.create','method'=>'GET','autocomplete'=>'on','role'=>'search'])!!}<!-- ojo aqui en url debes especificar el nombre de la ruta en routes con el que llamas el controlador eje en este caso le pones como nombre legalentity a la ruta que apunta alcontrolador tal -->
